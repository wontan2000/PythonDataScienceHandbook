...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/py4ds/WhirlwindTourOfPython//master?urlpath=lab/tree/notebooks/Index.ipynb)
...
- Launch a live notebook server with these notebooks using [Binder](https://beta.mybinder.org/): [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/py4ds/WhirlwindTourOfPython//master?urlpath=lab/tree/notebooks/Index.ipynb)
